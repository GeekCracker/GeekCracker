...
import com.xumengba.utils.ImageWaterMarkUtils;
import com.xumengba.utils.OSUtil;
...
public class UploadFileServiceImpl implements UploadFileService {
	...
	*/
	public String upload(String fileName,byte[] data,String waterContent){
		...
		String saveFilePath =UploadUtils.generateDirByDate("images");
		// 3、生成一个带路径+文件名     并根据不同的操作系统上传到不同的路径
		String saveFile = propertiesService.getWindowsRootPath() + File.separator + saveFilePath + File.separator + saveFileName;
		try {
			// 4、向磁盘中写文件
