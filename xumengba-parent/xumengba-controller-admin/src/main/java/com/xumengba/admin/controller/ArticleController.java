...
public class ArticleController extends BaseController{
	...
	public ResponseResult save(Article article){
		if(StringUtils.isBlank(article.getArticleTitle())){
			throw new BizException(StatusCode.ARTICLE_TITLE_BLANK);
		}
		Date date = new Date();
	...
	public ResponseResult getArticles(ArticleQueryForm articleQueryForm){
		...
		return ResponseResult.ok(articleService.queryData(queryHelper.getWhereSQL(), queryHelper.getWhereParams(),groupBy));
	}
	/**
