...
public enum StatusCode {
	...
	QUERY_BY_ID_EXCEPTION(1003,"根据id查询数据出现异常"),
	
	ENTITY_BLANK(1004,"要执行此操作，传入的对象不能为空"),
	
	INSERT_ENTITY_EXCEPTION(1005,"添加数据对象时出现异常"),
	
	INSERT_ENTITY_FIELD_NULL_EXCEPTION(1005,"添加数据对象时缺少需要添加的字段"),
	
	INSERT_ENTITY_VALUE_NULL_EXCEPTION(1005,"添加数据对象时缺少需要添加的字段值"),
	
	INSERT_ALL_EXCEPTION(1006,"添加数据列表时出现异常"),
	
	UPDATE_ENTITY_EXCEPTION(1007,"根据id修改数据时出现异常"),
	
	UPDATE_ENTITY_ID_BLANK(1007,"根据id修改时id为空"),
	
	DELETE_ENTITY_EXCEPTION(1007,"根据id删除数据时出现异常"),
	...
	ARTICLE_TITLE_BLANK(1127,"文章标题不能为空"),
	;
	private int code;
